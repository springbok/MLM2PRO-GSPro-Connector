...
class Ui_SettingsForm(object):
    def setupUi(self, SettingsForm):
        ...
        self.r10_ip_edit = QPlainTextEdit(self.groupBox)
        self.r10_ip_edit.setObjectName(u"r10_ip_edit")
        sizePolicy.setHeightForWidth(self.r10_ip_edit.sizePolicy().hasHeightForWidth())
        self.r10_ip_edit.setSizePolicy(sizePolicy)
        self.r10_ip_edit.setMinimumSize(QSize(0, 31))
        self.r10_ip_edit.setTabChangesFocus(True)

        self.verticalLayout_4.addWidget(self.r10_ip_edit)

        self.r10_port_edit = QPlainTextEdit(self.groupBox)
        self.r10_port_edit.setObjectName(u"r10_port_edit")
        sizePolicy.setHeightForWidth(self.r10_port_edit.sizePolicy().hasHeightForWidth())
        self.r10_port_edit.setSizePolicy(sizePolicy)
        self.r10_port_edit.setMinimumSize(QSize(0, 31))
        self.r10_port_edit.setTabChangesFocus(True)

        self.verticalLayout_4.addWidget(self.r10_port_edit)

        self.horizontalLayout_3 = QHBoxLayout()
        self.horizontalLayout_3.setObjectName(u"horizontalLayout_3")
        self.r10_path_edit = QPlainTextEdit(self.groupBox)
        self.r10_path_edit.setObjectName(u"r10_path_edit")
        sizePolicy.setHeightForWidth(self.r10_path_edit.sizePolicy().hasHeightForWidth())
        self.r10_path_edit.setSizePolicy(sizePolicy)
        self.r10_path_edit.setMaximumSize(QSize(16777215, 31))
        self.r10_path_edit.setLineWrapMode(QPlainTextEdit.WidgetWidth)

        self.horizontalLayout_3.addWidget(self.r10_path_edit)

        self.file_browse_button_2 = QPushButton(self.groupBox)
        self.file_browse_button_2.setObjectName(u"file_browse_button_2")

        self.horizontalLayout_3.addWidget(self.file_browse_button_2)
    ...
    def retranslateUi(self, SettingsForm):
        ...
        self.groupBox.setTitle(QCoreApplication.translate("SettingsForm", u"R10 Settings", None))
#if QT_CONFIG(tooltip)
        self.r10_ip_edit.setToolTip(QCoreApplication.translate("SettingsForm", u"IP Address", None))
#endif // QT_CONFIG(tooltip)
        self.r10_ip_edit.setPlaceholderText(QCoreApplication.translate("SettingsForm", u"IP Address", None))
#if QT_CONFIG(tooltip)
        self.r10_port_edit.setToolTip(QCoreApplication.translate("SettingsForm", u"Window Title", None))
#endif // QT_CONFIG(tooltip)
        self.r10_port_edit.setPlaceholderText(QCoreApplication.translate("SettingsForm", u"Port", None))
#if QT_CONFIG(tooltip)
        self.r10_path_edit.setToolTip(QCoreApplication.translate("SettingsForm", u"Application Path(Opyional)", None))
#endif // QT_CONFIG(tooltip)
        self.r10_path_edit.setPlaceholderText(QCoreApplication.translate("SettingsForm", u"R10 Connector Path", None))
        self.file_browse_button_2.setText(QCoreApplication.translate("SettingsForm", u"Browse", None))
#if QT_CONFIG(tooltip)
