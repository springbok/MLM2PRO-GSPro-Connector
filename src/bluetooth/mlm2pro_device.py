...
# Dynamic assignment of base class
# See https://stackoverflow.com/questions/21060073/dynamic-inheritance-in-python
def get_device_class(base):
    class MLM2PRODeviceQtBluetooth(base):
    ...
    return MLM2PRODeviceQtBluetooth